    ...
    <React.Fragment>
      <div className="nutrition-info" style={{display: "flex", justifyContent: "space-between"}}>
        <div style={{margin: "25px", textAlign: "left"}}>
          <h4 style={{color: "gray"}}>Weekly Goal Calories to <br/>{props.currentUserStatsNewCalc.goal}</h4>  
          <p style={{color: "gray"}}>{props.currentUserStatsNewCalc.calories_for_goal} x 7 days = {props.currentUserStatsNewCalc.calories_for_goal * 7}</p>
        </div>

        <div style={{margin: "25px", textAlign: "left"}}>
          <h4 style={{color: "gray"}}>Your current <br/>calories ordered</h4>  
            <p style={{color: "gray"}}>{caloriesAdded}</p>
          </div>
