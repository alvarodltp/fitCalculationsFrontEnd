...
const UserStats = (props) => {
  return(
    <div className="user-stats-dash">
      <div id="card-dashboard-pink" className="weight-chart-title">
      ...
      <div id="card-dashboard-pink" className="bmi-chart-title">
      ...
      <div id="card-dashboard-pink" className="expense-chart-title">
