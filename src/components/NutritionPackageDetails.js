  ...
  render() {
    return (
      <div id="nutrition-package-intro">
        ...
        <h4>What is BMR (Basal Metabolic Rate)? <Icon onClick={this.displayBmrInfo} name="angle down" size="1x"/></h4>
        ...
        <h4>Why are calories important? <Icon onClick={this.displayCaloriesInfo} name="angle down" size="1x"/></h4>
        ...
        <h4>Why are macronutrients important? <Icon onClick={this.displayMacrosInfo} name="angle down" size="1x"/></h4>
