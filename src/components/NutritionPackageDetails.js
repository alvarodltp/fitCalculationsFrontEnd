  ...
  render() {
    return (
      <div id="nutrition-package-intro">
        ...
        <h4>What is BMR (Basal Metabolic Rate)? <FontAwesomeIcon onClick={this.displayBmrInfo} icon="angle-down" size="1x"/></h4>
        ...
        <h4>Why are calories important? <FontAwesomeIcon onClick={this.displayCaloriesInfo} icon="angle-down" size="1x"/></h4>
        ...
        <h4>Why are macronutrients important? <FontAwesomeIcon onClick={this.displayMacrosInfo} icon="angle-down" size="1x"/></h4>
