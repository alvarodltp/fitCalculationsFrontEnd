      ...
      <div style={{width: "80%", margin: "0 auto", marginTop: "40px"}}>
        ...
        <div id="what-you-get">
          <Card>
            ...
            <Card.Content>
              <Card.Header>DETAILED PLAN</Card.Header>
          ...
          <div id="landing-main-benefits">
            ...
            <Grid id="transformation-images" stackable columns={2}>
              <Grid.Row>
                <Grid.Column width={5}>
                  <Image style={{width: "250px", margin: "0 auto", marginBottom: "20px"}} src={'../ebook.png'} />
                </Grid.Column>
            ...
            <div id="landing-main-benefits">
              ...
              <Grid id="transformation-images" stackable columns={3}>
                <Grid.Row>
                  <Grid.Column>
                  <Card>
                    <Image id="img-motivation" src={'../Brandt.png'} />
                    <Card.Content>
          ...
          <div style={{width: "100%", background: "#eaeaea"}}>
            <h1 style={{fontSize:"40px", paddingTop: "40px"}}>100% No-Risk Money Back Guarantee!</h1><br/>
            <div id="landing-main-benefits">
