      ...
      <React.Fragment>
        <div>
          ...
          <div style={{width: "70%", margin: "0 auto"}}>
            ...
            onClick={(e) => {this.getEvent(); this.props.saveUser(); this.props.activateConfetti(); this.props.scrollToTop()}}
            >SUBMIT!</Button> :
            <Button size="large" id="button-get-email" type='submit'
            onClick={(e) => {this.props.notify(); this.getEvent(); this.props.saveUser(); this.props.activateConfetti(); this.props.scrollToTop()}}>SUBMIT!</Button>}
        </div><br/>
      </React.Fragment>
    )
  }
