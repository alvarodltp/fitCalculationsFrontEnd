        ...
        <Card id="bmr-form-mobile">
          <Card.Content extra>
            <Form>
              ...
              <Button size="large" disabled={this.props.buttonDisabled} id="button" style={{width: "100%"}} onClick={() => {this.props.hideForm(); this.props.calculateBmr(this.state.value); this.props.addOneToStep(); this.props.calculateCalories(); this.props.saveUser(); this.props.scrollToTop()}} type="submit">
                STEP 2 - SELECT BODY TYPE <Icon name="right arrow" />
              </Button> :
              <Button size="small" disabled={this.props.buttonDisabled} id="button-mobile" style={{width: "100%"}} onClick={() => {this.props.hideForm(); this.props.calculateBmr(this.state.value); this.props.addOneToStep(); this.props.calculateCalories(); this.props.saveUser(); this.props.scrollToTop()}} type="submit">
                STEP 2 - SELECT BODY TYPE <Icon name="right arrow" />
              </Button> }
            </Form>
          </Card.Content>
