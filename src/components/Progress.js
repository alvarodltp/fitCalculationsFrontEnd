  ...
  render() {
    return(
      ...
      <div id="progress-bar">
        ...
        <div id="steps-on-bar">
          <p id="steps-text" style={{fontWeight: "bold"}}>Step 1 - Your Information <Icon style={{color: "#7CFC00"}} name='check' /></p>
          {this.props.stepNumber === 2 || this.props.stepNumber === 3 ? <p id="steps-text" style={{fontWeight: "bold"}}>Step 2 - Your Body Type <Icon style={{color: "#7CFC00"}} name='check' /></p> : <p id="steps-text">Step 2 - Select Your Body Type</p>}
